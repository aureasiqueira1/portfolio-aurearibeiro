            ...
            <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
              <Col md={4} className="project-card">
                <ProjectCard
                  ...
                  tecnology={
                    "React, JavaScript, CSS, PostgreSQL, Express, TypeORM, Postman"
                  }
                />
              </Col>
              <Col md={4} className="project-card">
                <ProjectCard
                  ...
                  tecnology={
                    "React, TypeScript, Styled Components, NestJs, TypeORM, PostgreSQL"
                  }
                />
              </Col>
              <Col md={4} className="project-card">
                <ProjectCard
                  ...
                  tecnology={
                    "React, TypeScript, Styled Components, NestJs, TypeORM, PostgreSQL, Swagger"
                  }
                />
              </Col>
              <Col md={4} className="project-card">
              ...
              <Col md={4} className="project-card">
                <ProjectCard
                  ...
                  tecnology={
                    "NextJs, TypeScript, Tailwind, SpeechRecognition API"
                  }
                />
              </Col>
              <Col md={4} className="project-card">
